-- Fix: net.http_post erwartet body als jsonb und die Signatur (url, body, params, headers).
-- Fehler war: body als text + falsche benannte Parameter → PostgreSQL fand keine passende Überladung.
