-- Fix: approval_token is uuid in production; RPC compared uuid = text (42883).
-- Also persist optional giver/quote fields atomically in the RPC.

DROP FUNCTION IF EXISTS public.complete_client_approval(text, text, text);
