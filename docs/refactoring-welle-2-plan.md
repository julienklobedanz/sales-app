...
- **P2 – erledigt (Company-Detail):** **(7)** `account-detail-client.tsx` in Tab-, Header- und Dialog-Module unter `app/dashboard/accounts/` aufgeteilt (`account-detail-*`, `company-stakeholder-*`, `account-contact-dialog`).
