...
| P1-10 | Legacy-Mapping                                              | `lib/roles/legacy-mapping.ts` ~30+ Importe                                      | UI-Labels → system/function; Mapping schrumpfen                                | M       | Welle 5 — **Teil ✅** `capability-access.ts`; Inbox/CC dimensions-basiert; Bridge ~14 Importe |
