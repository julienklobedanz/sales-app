...
| P1-10 | Legacy-Mapping                                              | `lib/roles/legacy-mapping.ts` ~30+ Importe                                      | UI-Labels → system/function; Mapping schrumpfen                                | M       | Welle 5 — **Teil ✅** Labels/Badges/Settings/Inbox; Bridge Rest: Invite/RPC/`useRole.role` |
