...
| P1-10 | Legacy-Mapping                                              | `lib/roles/legacy-mapping.ts` ~30+ Importe                                      | UI-Labels → system/function; Mapping schrumpfen                                | M       | Welle 5 — **nahezu ✅** effectiveRole/`useRole.role` weg; Rest: Invite/RPC/Onboarding/Dev-Preview |
