...
import { ReferenceDetailApprovalCard } from '@/app/dashboard/references/[id]/reference-detail-approval-card'
import { ReferenceDetailHeader } from '@/app/dashboard/references/[id]/reference-detail-header'
import { splitTags } from '@/app/dashboard/references/[id]/reference-detail-helpers'
import { ReferenceReadinessActions } from '@/app/dashboard/references/[id]/reference-readiness-actions'
import { ReferenceViewedTracker } from '@/app/dashboard/references/[id]/reference-viewed-tracker'
import { deleteReferenceFromDetailPage } from '@/app/dashboard/references/[id]/actions'
