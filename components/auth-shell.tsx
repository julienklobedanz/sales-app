...
const AUTH_FORM_COLUMN_CLASS =
  'relative flex min-h-screen flex-col items-center justify-center bg-background px-8 py-10 text-foreground lg:px-16 [&_[data-slot=input]]:border-border [&_[data-slot=input]]:bg-background [&_[data-slot=input]]:text-foreground [&_[data-slot=input]]:shadow-sm [&_[data-slot=input]]:placeholder:text-muted-foreground [&_[data-slot=label]]:text-foreground [&_.bg-border]:bg-accent'
