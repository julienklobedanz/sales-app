 ...
 */
export const TABLE_COLUMN_HEAD_SEPARATOR =
...
export const TABLE_COLUMN_HEAD_CLASS =
  `relative h-10 align-middle px-2 text-xs font-semibold text-muted-foreground whitespace-nowrap transition-colors hover:bg-accent/45 hover:text-foreground ${TABLE_COLUMN_HEAD_SEPARATOR}`
