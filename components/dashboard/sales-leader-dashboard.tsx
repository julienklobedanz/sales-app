              ...
              >
                <div className="min-w-0 flex-1 text-sm">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {deal.valueLabel} · {deal.coverageLabel}
                  </p>
                </div>
                <Badge variant="outline" className={cn('text-[11px]', deal.tone === 'ok' ? 'border-primary/30 bg-primary/10 text-primary' : deal.tone === 'warn' ? 'border-amber-300/60 bg-amber-50 text-amber-900' : 'border-destructive/30 bg-destructive/10 text-destructive')}>
