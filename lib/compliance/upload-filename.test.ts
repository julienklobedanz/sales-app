...
describe('sanitizeComplianceFileNamePart', () => {
  it('normalisiert Umlaute und Sonderzeichen', () => {
    expect(sanitizeComplianceFileNamePart('RefStack Demo Workspace')).toBe(
      'RefStack_Demo_Workspace',
    )
...
describe('buildDefaultComplianceTitle', () => {
  it('setzt Dokumenttyp und Jahr', () => {
    expect(buildDefaultComplianceTitle('iso_27001', undefined, 2026)).toBe(
      'ISO 27001 2026',
    )
  })
})
