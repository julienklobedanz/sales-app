...
describe('rfp-cockpit-metrics', () => {
      ...
      [
        {
          requirementId: 'r1',
          requirementText: 'A',
          matches: [{ id: '1', title: 'T', summary: null, industry: null, similarity: 0.4, companyName: 'C' }],
        },
        {
          requirementId: 'r2',
          requirementText: 'B',
          matches: [{ id: '2', title: 'T2', summary: null, industry: null, similarity: 0.2, companyName: 'C' }],
        },
      ],
      0.35
    )
  ...
  it('degrades recommendation when stale', () => {
    const rec = resolveBidRecommendation({ winProbability: 90, hasAnalysis: true, isStale: true })
  ...
  it('returns BID for high win probability when fresh', () => {
    const rec = resolveBidRecommendation({ winProbability: 80, hasAnalysis: true, isStale: false })
