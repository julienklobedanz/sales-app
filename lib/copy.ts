export const COPY = {
  ...
  deals: {
    ...
    cockpit: {
      ...
      rfpBlockSubtitle: 'Metriken aus der letzten RFP-Analyse — Eignung und Risiken folgen in späteren Schritten.',
      rfpBlockEmpty: 'Noch keine abgeschlossene RFP-Analyse für diesen Deal.',
      rfpAnalyzeCta: 'RFP analysieren',
      rfpBlockPhaseHint: 'Eignungs-Check, Risiken und Antwort-Entwürfe werden in den nächsten Phasen ergänzt.',
      ...
      metricEligibilityPlaceholder: 'Phase 5',
      metricEligibilityHint: 'Strukturierter K.O.-Check folgt — Profil in Settings vorbereiten.',
