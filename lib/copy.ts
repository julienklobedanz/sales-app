export const COPY = {
  ...
  deals: {
    ...
    cockpit: {
      ...
      risksSmeTitle: 'Offene fachliche Themen · {count}',
  ...
  marketSignals: {
    ...
    filterChipAll: 'Alle',
    filterChipPeople: 'Personen',
    filterChipCompany: 'Firma',
    /** Personen auf der Executive-Watchlist (Verwalten → Executives). */
    filterChipChampions: 'Meine Champions',
    filterChipWithDeal: 'Mit Deal',
