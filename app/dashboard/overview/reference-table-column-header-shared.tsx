...
export function SearchableRadioFilterHeader({
  label,
  filterValue,
  setFilter,
  search,
  ...
  return (
    <>
      ...
      <ColumnSortButton
        ...
        activePrimary={sortActivePrimary}
      />
    </>
  )
}

export function CheckboxFilterHeader({
  label,
  filterValue,
  setFilter,
  options,
    ...
    <>
      <Popover>
        ...
        <PopoverContent
          ...
          onOpenAutoFocus={(e) => e.preventDefault()}
        >
          {search !== undefined && setSearch && searchPlaceholder ? (
            <Input
              autoFocus
              placeholder={searchPlaceholder}
              value={search}
