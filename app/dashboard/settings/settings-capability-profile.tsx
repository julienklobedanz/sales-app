...
import { SETTINGS_CARD_CLASS } from './tabs/settings-tab-shared'
  ...
  return (
    <div className={SETTINGS_CARD_CLASS}>
      <CardHeader className="space-y-2 px-0 pt-0">
        <CardTitle className="text-base">{COPY.settings.capabilityProfile.title}</CardTitle>
        <CardDescription className="text-slate-500">
          {COPY.settings.capabilityProfile.description}
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6 px-0 pb-0 pt-1">
        {emptyProfile ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="cap-employee-count">{COPY.settings.capabilityProfile.employeeCount}</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="cap-revenue">{COPY.settings.capabilityProfile.annualRevenue}</Label>
            <Input
              id="cap-revenue"
        ...
        <div className="space-y-2">
          <Label htmlFor="cap-regions">{COPY.settings.capabilityProfile.regions}</Label>
          <Input
            id="cap-regions"
            value={regions}
        ...
        <div className="space-y-2">
          <Label htmlFor="cap-roles">{COPY.settings.capabilityProfile.certifiedRoles}</Label>
          <Textarea
            id="cap-roles"
        ...
        <div className="border-t border-slate-200 pt-4">
          <p className="mb-3 text-sm font-medium">{COPY.settings.capabilityProfile.icpTitle}</p>
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="icp-industry">{COPY.settings.capabilityProfile.icpIndustry}</Label>
              <Input
                id="icp-industry"
                value={icpIndustry}
            ...
            <div className="space-y-2">
              <Label htmlFor="icp-volume">{COPY.settings.capabilityProfile.icpVolume}</Label>
              <Input
                id="icp-volume"
                value={icpVolume}
            ...
            <div className="space-y-2">
              <Label htmlFor="icp-region">{COPY.settings.capabilityProfile.icpRegion}</Label>
              <Input
                id="icp-region"
                value={icpRegion}
            ...
            <div className="space-y-2">
              <Label htmlFor="icp-account">{COPY.settings.capabilityProfile.icpAccountSize}</Label>
              <Input
                id="icp-account"
            ...
            <div className="space-y-2 sm:col-span-2">
              <Label htmlFor="icp-segment">{COPY.settings.capabilityProfile.icpSegment}</Label>
              <Input
                id="icp-segment"
                value={icpSegment}
